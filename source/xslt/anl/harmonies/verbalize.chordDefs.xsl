...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mei:chordDef" mode="verbalize.chordDefs.thirds-based-chords.plain">
       ...
       <!-- major 9th chord-->
        ...
        <xsl:if test="not(mei:chordMember[@temp:cost='1']) and mei:chordMember[@inth='M2']">
        ...
        <xsl:if test="mei:chordMember[@type='65sus']">
            <rend xmlns="http://www.music-encoding.org/ns/mei" rend="sup" type="mod65sus">65sus</rend>
        </xsl:if>
        <xsl:if test="mei:chordMember[@type='98sus']">
            <rend xmlns="http://www.music-encoding.org/ns/mei" rend="sup" type="mod98sus">98sus</rend>
        </xsl:if>
        <xsl:if test="mei:chordMember[@type='23ret']">
            <rend xmlns="http://www.music-encoding.org/ns/mei" rend="sup" type="mod23ret">23ret</rend>
        </xsl:if>
        <xsl:if test="mei:chordMember[@type='78ret']">
            <rend xmlns="http://www.music-encoding.org/ns/mei" rend="sup" type="mod78ret">78ret</rend>
        </xsl:if>
